...
## 3. 프로젝트 구조
![image](https://github.com/JaeHyungL2/Diabetes/assets/150316684/0fe754ab-829d-4672-a0b6-9c31fc52a698)
...
d
깃헙을 통한 협업에 익숙해지는 것, 서로 감정 상하지 않고 무사히 마무리하는 것이 1차적인 목표였어서 항상 이 부분을 명심하면서 작업했습니다.d
d
